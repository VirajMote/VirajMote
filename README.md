...
📊 **Data Systems** — Pipelines, ETL, and working with messy real-world datasets  
⚙️ **Backend Engineering** — Scalable APIs, system design, and building systems that don’t break  
🔬 **ML Pipelines** — End-to-end model training, evaluation, and deployment  
🤖 **AI Research** — Reading papers, reproducing results, and staying close to the research frontier  
